...
<p>Inna Zhalybina<br />Lindwurmstra&szlig;e 101<br />80337 M&uuml;nchen</p>
<p>Telefon: +49 157 30677320<br />E-Mail: Polerinna@t-online.de</p>
...
<p style="margin-top:2rem;color:#a3a3a3;font-size:0.875rem;">Quelle: <a href="https://www.e-recht24.de" target="_blank" rel="noopener noreferrer">e-recht24.de</a></p>
`;
...
export default function DatenschutzPage() {
  return (
    <div className="pt-20 min-h-screen bg-white">
      <div
        className="max-w-3xl mx-auto px-6 py-16 legal-prose"
